...
- ✅ دو میان‌بر مستقل و کاملاً قابل تنظیم از طریق منوی تنظیمات
  - اصلاح متن انتخاب‌شده یا کل خط (در صورت انتخاب نبودن متن، اصلاح خودکار کل خط جاری)
  - اصلاح آخرین کلمه

- ✅ تنظیم مستقل رفتار هر میان‌بر پس از اصلاح
  - برای هر میان‌بر از طریق منوی تنظیمات می‌توان مشخص کرد که پس از انجام عملیات، زبان صفحه‌کلید ویندوز به‌صورت خودکار تغییر کند یا بدون تغییر باقی بماند.

- ✅ تشخیص خودکار جهت اصلاح (فارسی ↔ انگلیسی) با استفاده از الگوریتم وزن‌دهی

- ✅ حفظ کامل فاصله‌ها و تبدیل علائم نگارشی
